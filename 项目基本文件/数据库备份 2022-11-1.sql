...
insert  into `Open`(`floor_id`,`floor_name`,`floor_status`,`people_count`,`time_id`) values (1,'一层','FS001',92,1),(2,'二层','FS001',99,3),(3,'三层','FS001',100,3),(4,'四层','FS001',100,3),(5,'五层','FS001',100,3);
...
insert  into `Scheduled`(`scheduled_id`,`user_id`,`book_name`,`scheduled_status`) values ('1584480561142112256',1,'张三的幸福一天','RS001'),('1587274892995383296',1,'夏日终曲','RS001'),('1587279452849754112',1,'撒野','RS001'),('1587279626548465664',1,'测试数据','RS001');
...
insert  into `activity`(`activityId`,`activityName`,`activityTypeId`,`activityInfo`,`activityOrganizer`,`activityDate`,`activityApplication`,`activityAge`,`activityStatus`,`activityDelete`) values (1,'亲子贴贴乐',1,'父母和孩子一起玩贴一贴游戏，当在规定时间内贴一贴次数最高获胜','[\"腾讯\",\"小米\"]','2022-10-27 10:18:13','2022-10-25 10:18:19',12,'ACS03',0),(2,'读者见面会',1,'读者见面交流','[\"腾讯\",\"小米\"]','2022-11-01 14:16:21','2022-11-01 15:17:23',13,'ACS01',0);
...
insert  into `application`(`applicationId`,`userId`,`applicationStatus`,`activityId`) values ('1',1,'APS03',1),('1587337656975724544',1,'APS01',2),('2',2,'APS03',1);
...
insert  into `bookTag`(`tag_id`,`tag_value`,`tag_delete`,`user_id`) values (1,'爱情',0,NULL),(2,'测试数据',1,1),(3,'幻想',0,1),(4,'纯情\n',0,1),(7,'历史',1,1),(8,'现实',1,1),(9,'历史',0,2),(10,'历史',0,1);
...
insert  into `bookTap`(`id`,`bookId`,`tapId`,`userId`) values (1,'8',1,NULL),(2,'8',2,1),(4,'7',3,1),(5,'3',4,1),(10,'2',7,1),(11,'8',8,1),(12,'undefined',9,2),(13,'undefined',9,2),(14,'undefined',10,1),(15,'undefined',10,1),(16,'undefined',10,1),(17,'undefined',10,1);
